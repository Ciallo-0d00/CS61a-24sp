...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    total = 3 * abs(((opponent_score // 10) % 10) - player_score % 10)
    if total == 0:
        return 1
    return total
    # END PROBLEM 2
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    if boar_brawl(score, opponent_score) >= threshold:
        return 0
    elif sus_points(score + boar_brawl(score, opponent_score)) - score >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
